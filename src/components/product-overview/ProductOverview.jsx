...
const ProductOverview = () => {
    ...
    const ProductCard = ({ product }) => (
        <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 h-full flex flex-col">
            ...
            <div className="p-4 flex flex-col flex-grow">
                ...
                <p className="text-green-600 font-bold text-lg mb-3 mt-auto">₦{product.price}</p>
    ...
    return (
        <section className="py-4 md:py-8 lg:py-16 bg-white dark:bg-gray-900 antialiased relative">
                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16 mb-8 md:mb-16">
                    ...
                    <div className="mb-6 md:mb-0 relative">
                        ...
                        <div className="max-w-md mx-auto lg:max-w-lg">
                            <div className="relative pt-[100%] md:pt-[75%]"> {/* Square on mobile, 4:3 on desktop */}
                                <img
                    ...
                    <div className="space-y-4 md:space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            ...
                            <button className="flex items-center justify-center px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors flex-1">
            ...
            {/* Floating Back Button for Mobile (alternative placement) */}
            <button
                onClick={handleGoBack}
