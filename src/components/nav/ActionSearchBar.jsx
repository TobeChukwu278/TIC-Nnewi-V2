...
import { motion, AnimatePresence } from "framer-motion"; // use framer-motion in React
import {
    Search,
    Send,
    BarChart2,
...
const allActionsSample = [
    {
        id: "1",
        label: "Search for 'Engine Spare Parts' ",
    ...
    {
        id: "3",
        label: "Search for 'Motorcycle Accessories'",
    ...
    {
        id: "4",
        label: "Search for 'Home Electronics'",
    ...
    {
        id: "5",
        label: "Search for 'Electronics & Gadgets'",
    ...
    {
        id: "6",
        label: "Search for 'Generators & Power Supply'",
        icon: <LayoutGrid className="h-4 w-4 text-blue-500" />,
        description: "Components",
        short: "",
        end: "Link",
                ...
                <div className="w-full max-w-sm relative">
                    <AnimatePresence>
                        {isFocused && result && !selectedAction && (
                            <motion.div
                                className="absolute top-full left-0 w-full border rounded-md shadow-xs overflow-hidden dark:border-gray-800 bg-white dark:bg-black mt-1 z-50"
                                ...
                                <motion.ul role="none">
                                    {result.actions.map((action) => (
                                        <motion.li
                                            key={action.id}
                                            id={`action-${action.id}`}
                                            className={`px-3 py-2 flex items-center justify-between hover:bg-gray-200 dark:hover:bg-zinc-900 cursor-pointer rounded-md ${activeIndex === result.actions.indexOf(action)
